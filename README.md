...
[![Go Reference](https://pkg.go.dev/badge/github.com/carmel/lz4.svg)](https://pkg.go.dev/github.com/carmel/lz4)
...
```
go get github.com/carmel/lz4
```

There is a command line interface tool to compress and decompress LZ4 files.

```
go install github.com/carmel/lz4/cmd/lz4c
```
